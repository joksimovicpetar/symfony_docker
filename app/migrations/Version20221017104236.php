...
final class Version20221017104236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("
                            ...
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (1, 'Avocado');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (2, 'Edamame');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (3, 'Spring Onion');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (4, 'Chili pepper');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (5, 'Shallots');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (6, 'Carrot');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (7, 'Green Salad');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (8, 'Beet');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (9, 'Pickles');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (10, 'Cucumber');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (11, 'Corn');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (12, 'Mango');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (13, 'Wasabi');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (14, 'Pineapple');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (15, 'Kohlrabi');
                            INSERT INTO symfony_docker.ingredient (id, name) VALUES (16, 'Nori algae');
                            
                            INSERT INTO symfony_docker.extra_ingredient (id, name, currency, price) VALUES (1, 'Avocado +4 slices', '$', 0.99);
                            INSERT INTO symfony_docker.extra_ingredient (id, name, currency, price) VALUES (2, 'Guacamole paste', '$', 0.49);
                            INSERT INTO symfony_docker.extra_ingredient (id, name, currency, price) VALUES (3, 'Ginger', '$', 0.49);
                            INSERT INTO symfony_docker.extra_ingredient (id, name, currency, price) VALUES (4, 'Wakame algae', '$', 0.99);
                            INSERT INTO symfony_docker.extra_ingredient (id, name, currency, price) VALUES (5, 'Black sesame', '$', 0.49);
                            INSERT INTO symfony_docker.extra_ingredient (id, name, currency, price) VALUES (6, 'Pumpkin seeds', '$', 0.99);
